...
\doxysection*{\href{https://moetsi.gitbook.io/sensor-stream-pipe/}{\texttt{ Checkout the Sensor Stream Pipe gitbook for full documentation}}}



\doxysection*{What is Sensor Stream Pipe?}
...
\item \href{https://azure.microsoft.com/en-us/services/kinect-dk/}{\texttt{ Azure Kinect DK}} R\+G\+B-\/D camera
\item seminal computer vision/spatial computing datasets (e.\+g. \href{https://graphics.stanford.edu/projects/bundlefusion/}{\texttt{ Bundle\+Fusion}}, \href{https://www.microsoft.com/en-us/research/project/rgb-d-dataset-7-scenes/}{\texttt{ MS R\+G\+B-\/D 7 scenes}} and \href{http://graphics.stanford.edu/projects/vsfs/}{\texttt{ V\+S\+FS}})
\item i\+OS A\+R\+Kit data (streams \href{https://developer.apple.com/documentation/arkit/arframe}{\texttt{ A\+R\+Frame data}})
\end{DoxyItemize}
...
\href{https://moetsi.gitbook.io/sensor-stream-pipe/}{\texttt{ Checkout the Sensor Stream Pipe gitbook for full documentation}}
...
\item Support for Azure Kinect DK (live and recorded video streaming) and image datasets (e.\+g. \href{https://graphics.stanford.edu/projects/bundlefusion/}{\texttt{ Bundle\+Fusion}}, \href{https://www.microsoft.com/en-us/research/project/rgb-d-dataset-7-scenes/}{\texttt{ MS R\+G\+B-\/D 7 scenes}} and \href{http://graphics.stanford.edu/projects/vsfs/}{\texttt{ V\+S\+FS}}) and .mkv (matroska) files
...
\doxysubsubsection*{But why though...?}
...
\doxysubsection*{Component parts}

\href{https://moetsi.gitbook.io/sensor-stream-pipe/}{\texttt{ Checkout the Sensor Stream Pipe gitbook for full documentation}}

\doxysubsubsection*{\href{https://moetsi.gitbook.io/sensor-stream-pipe/components-overview/sensor-stream-server}{\texttt{ Sensor Stream Server}}}
...
\doxysubsubsection*{\href{https://moetsi.gitbook.io/sensor-stream-pipe/components-overview/sensor-stream-client}{\texttt{ Sensor Stream Client}}}
...
\doxyparagraph*{Sensor Stream Client with Open\+CV processing}
...
\doxysubsubsection*{\href{https://moetsi.gitbook.io/sensor-stream-pipe/components-overview/sensor-stream-tester}{\texttt{ Sensor Stream Tester}}}
...
We recommend going through \href{https://moetsi.gitbook.io/sensor-stream-pipe/streaming-a-video}{\texttt{ Streaming a Video from our Gitbook}}
...
\doxysubsection*{Sensor Stream Pipe Development}
...
We would also love to hear more about how you plan to use the Moetsi Sensor Stream Pipe! So if you have any problems, questions, feature requests, or ideas for improvement, please feel free to reach out at \href{mailto:olenka@moetsi.com}{\texttt{ olenka@moetsi.\+com}}.

The better we understand how you’re using the Moetsi S\+SP, the better we can plan future developments!

\doxysubsubsection*{About Moetsi}
...
\doxysubsubsection*{How to Contribute}

We’re always excited to work with like-\/minded people, and invite you to experiment with our pipeline however you like! If you enjoy our work and think you can help take this project to the next level, feel free to drop us a message on \href{mailto:olenka@moetsi.com}{\texttt{ olenka@moetsi.\+com}} to get involved.
...
\doxysubsubsection*{Moetsi’s Permissive License}

Moetsi’s Sensor Stream Pipe is licensed under the M\+IT license. That means that we don’t require attribution, but we’d really like to know what cool things you’re using our pipe for. Drop us a message on \href{mailto:olenka@moetsi.com}{\texttt{ olenka@moetsi.\+com}} or post on our \href{https://moetsi.com/pages/community}{\texttt{ forum}} to tell us all about it!

\doxysubsubsection*{Support Moetsi!}

Our Sensor Stream Pipe is always going to be free, but it has taken a lot of blood, sweat and tears to get to this point. If you love what we’ve made, please consider reaching out to \href{mailto:olenka@moetsi.com}{\texttt{ olenka@moetsi.\+com}}.

\doxysubsubsection*{Authors}


\begin{DoxyItemize}
\item {\bfseries{André Mourão}} -\/ \href{https://github.com/amourao}{\texttt{ amourao}}
\item {\bfseries{Olenka Polak}} -\/ \href{https://github.com/olenkapolak}{\texttt{ olenkapolak}}
\item {\bfseries{Adam Polak}} -\/ \href{https://github.com/adammpolak}{\texttt{ adammpolak}} 
\end{DoxyItemize}