...
\begin{center}
\leavevmode
\includegraphics[width=224pt]{classmoetsi_1_1ssp_1_1ImageReader__inherit__graph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=224pt]{classmoetsi_1_1ssp_1_1ImageReader__coll__graph}
\end{center}
\end{figure}
