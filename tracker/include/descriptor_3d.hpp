...
///
/// \brief The IImageDescriptor_3d class declares base class for image
/// descriptor.
///
...
public:
    ...
    virtual ~IImageDescriptor_3d() {}
};

///
/// \brief Uses resized image as descriptor.
///
class ResizedImageDescriptor : public IImageDescriptor_3d {
public:
    ///
    /// \brief Constructor.
...
class Descriptor : public IImageDescriptor_3d {
private:
    VectorCNN handler;
